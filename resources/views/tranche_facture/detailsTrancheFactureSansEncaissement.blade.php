          ...
          <div style="margin-top: -40px;" class="order-summary">
                        <div class="table-responsive">
                            <table class="table invoice-table">
                              ...
                              <tbody>
    @if($trancheFacture)
        @foreach($trancheFacture->facture->choixBanques as $index => $choixBanque)
            <tr>
                <td style="text-align:center;">
                {{ $choixBanque->banque->type ?? '' }}
                </td>
                <td style="text-align:center;">
                    {{ $choixBanque->banque->nom_banque ?? 'N/A' }}
                </td>
                <td style="text-align:center;">
                    {{ $choixBanque->banque->compte ?? 'N/A' }}
                </td>
                <td style="text-align:center;">
                @if($index === 0)    A la réception   @endif
                </td>
            </tr>
        @endforeach
    @else
        <tr>
            <td colspan="4" style="text-align:center;">
                Aucune donnée trouvée pour cette tranche de facture.
            </td>
        </tr>
    @endif
