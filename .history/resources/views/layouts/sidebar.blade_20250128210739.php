 ...
 <aside class="sidebar-nav-wrapper">
        ...
        <ul>
          ...
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_4" class="collapse dropdown-nav">
              ...
              <li>
                <a href="{{ route('verification') }}"> Suivi </a>
              </li>
          ...
          <li class="nav-item nav-item-has-children banque-item">
  <a
    href="#0"
    class="collapsed"
    data-bs-toggle="collapse"
  ...
  <ul id="ddmenu_4" class="collapse dropdown-nav">
    <li>
      <a href="{{ route('liste.banque') }}"> Liste banque </a>
    </li>
    <li>
      <a href="{{ route('tranche.emises') }}"> Ajouter banque </a>
    </li>
  </ul>
</li>
