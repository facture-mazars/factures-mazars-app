        ...
        <table class="table striped-table">
          ...
          @foreach ($banques as $banque)
            <tr>
                ...
                <td>      <a href="{{ route('banques.edit', $banque->id_banque) }}" class="btn btn-primary btn-sm">Modifier</a>
                </td>
            </tr>
        @endforeach
           <tr>
            ...
            <button type="submit" onclick="openEditModal({{ $banque->id_banque }})">Modifier</button>
        </td>
           </tr>
