...
<div id="editModal" style="display:none;">
    <div class="modal-content">
        ...
        <form id="editForm" method="POST" action="{{ url('/choix-banque/update/' . $choixBanque->id) }} class="form">
            @csrf
            @method('PUT')
            <div>
...
function openEditModal(id, nomBanque, compte, type) {
    ...
    // Définir l'action du formulaire avec l'ID spécifique
    document.getElementById('editForm').action = `/choix-banque/${id}`;
