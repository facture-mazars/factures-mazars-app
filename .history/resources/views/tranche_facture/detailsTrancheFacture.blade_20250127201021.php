          ...
          <div style="margin-top: -40px;" class="order-summary">
                        <div class="table-responsive">
                            <table class="table invoice-table">
                              ...
                              <tbody>
        @if($trancheFactures->isNotEmpty())
            @foreach($trancheFactures as $trancheFacture)
                @foreach($trancheFacture->facture->choixBanques as $choixBanque)
                    <tr>
                        <td style="text-align:center;">
                            {{ $choixBanque->banque->nom_payeur ?? 'N/A' }}
                        </td>
                        <td style="text-align:center;">
                        ...
                        <td style="text-align:center;">
                            {{ $choixBanque->banque->modalite ?? 'N/A' }}
                        </td>
                    </tr>
                @endforeach
            @endforeach
        @else
            <tr>
                <td colspan="4" style="text-align:center;">
                    Aucune donnée trouvée pour cette facture.
                </td>
            </tr>
        @endif
    </tbody>
