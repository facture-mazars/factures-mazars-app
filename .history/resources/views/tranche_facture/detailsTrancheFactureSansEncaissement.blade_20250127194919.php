                ...
                <div class="invoice-inner" id="invoice_wrapper">
                   ...
                   @foreach ($societes as $s )
                    ...
                    @endforeach
                      ...
                      <h6><span> N° IS &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp; </span>{{ $trancheFacture -> facture ->chantier->client->n_rcs }}</h6>
                          ...
                          <div class="invoice">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center">   {{  $trancheFacture ->date_reel_fac ?? $trancheFacture ->date_prevision_facture}}</td>
                                    <td class="text-right">  {{ $trancheFacture->numero_facture }}</td>
                                </tr>
...
@endif
          ...
          <div style="margin-top: -40px;"  class="order-summary">
                        <div class="table-responsive">
                           ...
                           <!-- Vérification si des banques existent -->
    @if($banques->isNotEmpty())
        <!-- Affichage des banques avec leurs informations -->
        @foreach($banques as $banque)
            <tr>
                <th class="text-center">Nom de la banque</th>
                <td class="text-center">{{ $banque->nom_banque }}</td>
                <th class="text-center">Type</th>
                <td class="text-center">{{ $banque->type }}</td>
            </tr>
            <tr>
                <th class="text-center">Compte</th>
                <td colspan="3" class="text-center">{{ $banque->compte }}</td>
            </tr>
        @endforeach
    @else
        <!-- Message en cas d'absence de banques -->
        <tr>
            <th colspan="4" class="text-center">
                <h6>Aucune banque trouvée</h6>
            </th>
        </tr>
    @endif
</tbody>
