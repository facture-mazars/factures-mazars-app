    ...
    @if($banquesEtTranches->isNotEmpty())
        @foreach($banquesEtTranches->groupBy('id_facture') as $id_facture => $details)
            ...
            @foreach($details as $detail)
                ...
                <tr>
                    <th class="text-center">Nom de la Tranche</th>
                    <td>{{ $detail->nom_tranche }}</td>
                    <th class="text-center">Taux Honoraire</th>
                    <td>{{ $detail->taux_honoraire }}%</td>
                </tr>
                <tr>
                    <th class="text-center">Montant Honoraire</th>
                    <td>{{ number_format($detail->montant_honoraire, 0, ',', ' ') }} Ar</td>
                </tr>
            @endforeach
        @endforeach
    @else
