                      ...
                      <tr>
                        ...
                        Secondary
                          ...
                          @if($c->trancheFacture->date_facture_annule)
                              <a href="{{ route('tranche.detailsansEncaissAnnuler', ['id_tranche_facture' => $c->id_tranche_facture]) }}" >
                                  Voir Facture 
                              </a>
                          @else
                              <a href="{{ route('tranche.detailsansEncaiss', ['id_tranche_facture' => $c->id_tranche_facture]) }}" >
                                  Voir facture
                              </a>
                          @endif
