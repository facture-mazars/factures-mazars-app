...
<div class="col-xxl-4">
    <div class="input-style-1">
        ...
        <!-- Champ de type number, avec valeur brute -->
        <input id="montant_a_encaisse" name="montant_a_encaisse" style="color: green; font-family : bold; font-size : 30px;" 
               type="number" 
               value="{{ $total_a_payer }}" 
               readonly>
        <!-- Affichage formaté pour les milliers -->
        <span id="formatted-total" style="font-size: 30px; font-weight: bold; color: green;">
            {{ number_format($total_a_payer, 0, ',', ' ') }}
        </span>
    </div>
</div>
