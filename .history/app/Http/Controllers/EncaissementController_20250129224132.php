...
$reste_a_payer = $total_a_payer - $total_encaisse;
    ...
    if ($resteAPayer <= 0) {
        $facture->updateFactureStatus($facture->id_facture); // Mettez à jour l'état de la facture si tout est payé
    }
...
public function updateFactureStatus(Facture $facture): void
{
    ...
    if ($facture->reste_a_payer <= 0) {
        ...
        $facture->etat = 'payée';  // Ou '1' si vous utilisez des entiers pour l'état
