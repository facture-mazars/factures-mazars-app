...
class ChoixBanqueController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        // Récupérer id_facture depuis le formulaire
      // Récupérer id_facture de la table choix_banque avec la banque mise à jour
    $id_facture = ChoixBanque::where('id_banque', $banque->id_banque)->first()->id_facture;
