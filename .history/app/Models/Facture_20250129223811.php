...
public function updateFactureStatus()
{
    ...
    if ($this->reste_a_payer <= 0) {
        // Marquez la facture comme payée (ou mettre à jour l'état comme vous le souhaitez)
        $this->etat = 'payée'; // ou '1' si vous utilisez des entiers pour l'état
        $this->save(); // Sauvegarde la mise à jour
    }
}
