...
Route::get('/consultant/listeClient', [ConsultantController::class, 'show'])->name('allClient'); 
    ...
    Route::get('/banques/edit/{id_facture}', [ChoixBanqueController::class, 'edit'])->name('banques.edit');
Route::put('/banques/update/{id_facture}', [ChoixBanqueController::class, 'update'])->name('banques.update');
