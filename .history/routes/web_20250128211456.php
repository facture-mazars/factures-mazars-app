...
Route::get('/banques/create', [ChoixBanqueController::class, 'create'])->name('banques.create');
Route::post('/banques', [ChoixBanqueController::class, 'store'])->name('banques.store');
